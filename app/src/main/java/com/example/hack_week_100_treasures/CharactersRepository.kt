...
class CharactersRepository {
    ...
    private val hardCodedGameCharacters: List<Character> = listOf(
        Character("David Attenborough", R.raw.attenborough, desc = "Broadcaster, natural historian and author", imageId = R.drawable.david_attenborough),
        Character("Doctor Who", R.raw.dr_who, desc = "Namesake of a science fiction TV show since 1963 starring the best blue box", imageId = R.drawable.drwho),
        Character("Hacker T. Dog", R.raw.hacker, desc= "Canine CBBC character from Wigan", imageId = R.drawable.hacker_dog),
        Character("Villanelle (Killing Eve)", R.raw.killing_eve, desc = "Psychopathic assassin in TV show Killing Eve", imageId = R.drawable.vilannelle),
        Character("Wallace and Gromit", R.raw.wallace, desc = "Animated inventor and his loyal dog", imageId = R.drawable.wallace_and_gromit),
